    ...
    <header className="sticky top-0 z-20 flex h-20 items-center gap-6 bg-background/80 backdrop-blur-xl px-8">
      <div className="flex-1 max-w-[400px]">
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 rounded-[18px] bg-[#121212] pl-11 pr-16 text-[13px] text-foreground placeholder:text-muted-foreground outline-none focus:bg-[#242424] transition"
          />
      ...
      <div className="ml-auto flex items-center gap-4">
        <button
          ...
          className="relative h-10 w-10 grid place-items-center rounded-[16px] bg-[#242424] hover:bg-[#2c2c2c] transition"
        >
          {theme === "dark" ? (
        ...
        <button className="relative h-10 w-10 grid place-items-center rounded-[16px] bg-[#242424] hover:bg-[#2c2c2c] transition">
          <Bell className="h-[18px] w-[18px] text-foreground" />
          <span className="absolute top-2.5 right-2.5 h-1.5 w-1.5 rounded-full bg-rose-500" />
        </button>
        <button className="flex items-center gap-1.5 rounded-[16px] bg-[#242424] pl-1 pr-2.5 py-1 hover:bg-[#2c2c2c] transition">
